                ...
                <CardContent className="p-0">
                  ...
                  <ol className="space-y-3 text-gray-600">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm sm:text-base">Enter the total amount that includes 15% VAT in the input field above</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-7 h-7 bg-primary text-white text-sm font-bold rounded-full mt-0.5 flex-shrink-0">
                        2
                      </span>
                      <span className="text-sm sm:text-base">The calculator will instantly show you three values: the original amount, the VAT portion, and the amount excluding VAT</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-7 h-7 bg-primary text-white text-sm font-bold rounded-full mt-0.5 flex-shrink-0">
                        3
                      </span>
                      <span className="text-sm sm:text-base">Click the copy button next to any result to copy it to your clipboard</span>
                    </li>
                  </ol>
      ...
      <section className="bg-white py-8 sm:py-12">
        <div className="max-w-4xl mx-auto mobile-padding sm:px-4">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8" aria-labelledby="use-cases">
              <article className="bg-green-50 border border-green-200 rounded-lg p-4">
                <h4 className="text-lg font-semibold text-green-900 mb-2">Business Invoicing</h4>
              ...
              <article className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="text-lg font-semibold text-blue-900 mb-2">Freelancer Quoting</h4>
              ...
              <article className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <h4 className="text-lg font-semibold text-purple-900 mb-2">Financial Reconciliation</h4>
              ...
              <article className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                <h4 className="text-lg font-semibold text-amber-900 mb-2">Retail and Consumer Checks</h4>
